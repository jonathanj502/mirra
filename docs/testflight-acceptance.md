...
| TF-6 | Recording continues for at least five minutes with the iPhone locked; after unlock/Stop, audio from before, during, and after lock reaches the debrief. | OPEN | Capture/save subcheck PENDING on installed `a4b3c14` (iPhone 13/iOS 26.6.2): an earlier “yes” was ambiguous and cannot establish completion. Device task is confirming the exact newest-clip duration and five full minutes locked. Read-only local inspection is being coordinated while offline; intact before/during/after-lock audio and the resulting debrief also remain unverified. |
